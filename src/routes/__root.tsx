...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-generated, ATS-friendly resumes with live editing." },
      { property: "og:title", content: "CareerPilot AI" },
      {
        property: "og:description",
        content: "AI-generated, ATS-friendly resumes with live editing and PDF export.",
      },
